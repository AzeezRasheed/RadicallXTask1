...
const internshipGuide = () => {
      ...
      <div className="absolute left-[311px] top-[57px] items-start w-[1000px]">
        ...
        <div className="flex flex-row justify-between items-start p-[16px] gap-[16px] h-[270px] rounded-2xl bg-white">
          <div className="flex flex-col items-start p-[16px] gap-[10px] w-[280px] h-[230px] bg-[#F6F5F9] rounded-xl ">
            <h1 className="capitalize font-bold text-[20px]">internship insights</h1>
            <p>
          ...
          <div>
            <div className="flex h-[48px] items-center justify-between bg-[#F2F2F2] gap-[10px] p-[8px] rounded-2xl mb-8">
              <div className="flex flex-row gap-2">
                <button className="bg-[#793EF5] py-[6px] px-[12px] rounded-xl text-white">This week</button>
                <button className="bg-white py-[6px] px-[12px] rounded-xl text-black ">This month</button>
              </div>
              <button className="flex flex-row gap-2 py-[6px] px-[12px] bg-[#FFFFFF] rounded-xl"> <img className="w-6" src={Calender} alt="" /> select dates</button>
            </div>
  ...
  <div className="px-[16px] py-[12px] mt-6 flex flex-row gap-3">
       ...
       <div className="w-[195px] h-[64px] ">
          <h1 className="font-[Space Grotesk] font-semibold text-[16px] mb-3">Product Design GVI</h1>
          <p className="text-[12px] font-[Space Grotesk] font-medium h-[32px] ">Amet miniymi mollit non deserunt est sit aliqua dolor do amet sint. </p>
        </div>
       </div>
  
       <div className=" w-[200px] p-[16px] flex flex-col h-[96px]  ">
       <div className="w-[195px] h-[64px] ">
          <h1 className="font-[Space Grotesk] font-semibold text-[16px] mt-2">120 Days</h1>
          <p className="text-[12px] font-[Space Grotesk] font-medium h-[32px] ">(created on 10/12/2021) </p>
        </div>
       </div>
      ...
      <div className="bg-[#F0EFFD]  text-center px-[8px] py-[10px] rounded-xl">
         ...
         <h1 className="text-[#793EF5] text-[18px] font-semibold  ">20000</h1>
      </div>
